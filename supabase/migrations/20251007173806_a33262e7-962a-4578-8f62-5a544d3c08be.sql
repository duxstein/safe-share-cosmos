...
CREATE INDEX IF NOT EXISTS idx_files_categories ON public.files USING GIN(categories);
CREATE INDEX IF NOT EXISTS idx_files_ipfs_cid ON public.files(ipfs_cid);
...
CREATE INDEX IF NOT EXISTS idx_file_ratings_file_id ON public.file_ratings(file_id);
CREATE INDEX IF NOT EXISTS idx_file_ratings_user_id ON public.file_ratings(user_id);
...
CREATE INDEX IF NOT EXISTS idx_file_comments_parent_id ON public.file_comments(parent_comment_id);
...
CREATE INDEX IF NOT EXISTS idx_file_favorites_file_id ON public.file_favorites(file_id);
CREATE INDEX IF NOT EXISTS idx_file_favorites_user_id ON public.file_favorites(user_id);
...
CREATE INDEX IF NOT EXISTS idx_file_downloads_created_at ON public.file_downloads(created_at DESC);
...
CREATE TABLE IF NOT EXISTS public.file_moderation (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  file_id UUID REFERENCES public.files(id) ON DELETE CASCADE NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_file_moderation_file_id ON public.file_moderation(file_id);
CREATE INDEX IF NOT EXISTS idx_file_moderation_status ON public.file_moderation(status);

-- Create file_seeders table (for P2P)
CREATE TABLE IF NOT EXISTS public.file_seeders (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  file_id UUID REFERENCES public.files(id) ON DELETE CASCADE NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_file_seeders_file_id ON public.file_seeders(file_id);
CREATE INDEX IF NOT EXISTS idx_file_seeders_last_seen ON public.file_seeders(last_seen DESC);
...
DROP TRIGGER IF EXISTS update_file_ratings_updated_at ON public.file_ratings;
...
DROP TRIGGER IF EXISTS update_file_moderation_updated_at ON public.file_moderation;
...
DROP TRIGGER IF EXISTS initialize_file_analytics_trigger ON public.files;
...
DROP TRIGGER IF EXISTS update_analytics_on_rating_insert ON public.file_ratings;
...
DROP TRIGGER IF EXISTS update_analytics_on_rating_update ON public.file_ratings;
CREATE TRIGGER update_analytics_on_rating_update
  AFTER UPDATE ON public.file_ratings
  FOR EACH ROW
  EXECUTE FUNCTION public.update_file_analytics_on_rating();

DROP TRIGGER IF EXISTS update_analytics_on_rating_delete ON public.file_ratings;
...
DROP TRIGGER IF EXISTS update_favorite_count_insert ON public.file_favorites;
...
DROP TRIGGER IF EXISTS update_favorite_count_delete ON public.file_favorites;
...
DROP TRIGGER IF EXISTS update_download_count_trigger ON public.file_downloads;
...
DROP TRIGGER IF EXISTS update_comment_count_insert ON public.file_comments;
...
DROP TRIGGER IF EXISTS update_comment_count_delete ON public.file_comments;
